  ...
  fork : isolation_fork begin
    fork
      ...
      begin
        ...
        // Drive rready and watch for the actual transfer. A beat is accepted on the clock edge where
        // rvalid is high and the rready we are driving is also high (the AXI handshake). We track the
        // rready we drive in rready_q rather than reading it back from the clocking block, and we
        // sample on that exact handshake edge. This is what makes the accept protocol-correct:
